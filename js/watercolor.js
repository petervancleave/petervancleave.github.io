class WatercolorEffect {
    constructor() {
        ...
        // Dark theme colors (deep navy and gray palette)
        this.darkColors = [
            { r: 13, g: 19, b: 33, a: 0.15 },    // Deepest Navy
            { r: 19, g: 29, b: 51, a: 0.15 },    // Dark Navy
            { r: 28, g: 39, b: 68, a: 0.15 },    // Navy
            { r: 45, g: 55, b: 72, a: 0.15 },    // Dark Slate Gray
            { r: 74, g: 85, b: 104, a: 0.15 },   // Slate Gray
            { r: 90, g: 103, b: 129, a: 0.15 }   // Light Slate Gray
        ];

        this.darkBaseColors = [
            { r: 13, g: 19, b: 33, a: 0.10 },    // Base Deepest Navy
            { r: 28, g: 39, b: 68, a: 0.10 },    // Base Navy
            { r: 45, g: 55, b: 72, a: 0.10 }     // Base Dark Slate Gray
        ];
